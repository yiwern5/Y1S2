...
public class Autocomplete extends JPanel implements DocumentListener, ActionListener {
    ...
    /**
     * Creates the GUI and shows it. For thread safety, this method should be invoked from the event dispatch thread.
     */
    ...
    void search(boolean complete) {
        ...
        String[] results = trie.prefixSearch(lookup, 500);
